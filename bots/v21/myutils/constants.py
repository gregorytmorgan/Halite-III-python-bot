...
DEBUG = DEBUG_NONE # DEBUG_GAME | DEBUG_TIMING| DEBUG_NAV | DEBUG_OUTPUT_GAME_METRICS | DEBUG_SHIP_STATES | DEBUG_GAME_METRICS
...
SHIP_MINING_THRESHOLD_DEFAULT = SHIP_MAX_HALITE * SHIP_FUEL_COST
